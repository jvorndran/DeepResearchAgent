...
const TerminalWindow = memo(function TerminalWindow({ title, children, testId, className }: { title: string; children: React.ReactNode; testId?: string; className?: string }) {
  return (
    <div className="relative group">
      ...
      <div className="relative border border-border bg-card/50 backdrop-blur-sm shadow-[4px_4px_0px_0px_var(--border)] overflow-hidden transition-all duration-500 group-hover:shadow-[4px_4px_0px_0px_var(--primary)]">
        ...
        <ScrollArea data-testid={testId} className={`h-[500px] w-full p-6 ${className ?? ""}`}>
          {children}
        </ScrollArea>
      </div>
    </div>
  ...
  return (
    <div className="lg:col-span-7 flex flex-col gap-6">
      ...
      <div ref={containerRef}>
        <TerminalWindow title="System.Log" testId="orchestrator-log">
          <div 
