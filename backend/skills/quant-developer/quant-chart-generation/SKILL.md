...
8. **Dual axes:** Use a right axis only when series have materially different
...
9. **Chart-heavy requests:** When the user asks for charts, a chart pack,
...
10. **Insight check:** Before saving, ask whether each chart makes the report
